...
export interface CompassAnswers {answers: Record<string, number>; compassSlug: string; id: Id<CompassAnswers>; ipAddress?: string; lang: string; results: Record<string, number>; updatedAt: Instant; userAgent?: string}
// class users.Role
